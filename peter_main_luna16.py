...
out_classes = 6
img_dir = os.path.join('/home/local/VANDERBILT/litz/data/luna16/preproc_train')
label_dir = os.path.join('/home/local/VANDERBILT/litz/data/luna16/fixed_labels')
...
root_dir = os.path.join('/home/local/VANDERBILT/litz/github/MASILab/lobe_seg/peter/luna16_0414/')
